      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
          ...
          <motion.h2 
            ...
            transition={{ duration: 0.5 }}
          >
            جلسات علاج طبيعي منزلية: راحتك في منزلك، صحتك بين أيدينا.
          </motion.h2>
          ...
          >
            نوفر جلسات علاج طبيعي في المنزل بأعلى كفاءة وأفضل أسعار، مع فريق مختص ومعتمد من وزارة الصحة لضمان راحتك وسلامتك.
          </motion.p>
